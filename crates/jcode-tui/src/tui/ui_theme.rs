pub(super) use jcode_tui_style::theme::{
    accent_color, ai_color, ai_text, asap_color, blend_color, border_color, dim_color,
    file_link_color, header_icon_color, header_name_color, header_session_color, pending_color,
