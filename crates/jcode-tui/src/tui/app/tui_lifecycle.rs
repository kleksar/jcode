...
impl App {
    ...
    pub(super) fn new_minimal_with_session(
        ...
        let mut app = Self {
            ...
            worktree_pane: Default::default(),
            files_inspector: Default::default(),
            ...
            pending_session_start_prompt: None,
            ...
            pending_session_creation_context: false,
            in_flight_session_creation_context: None,
            in_flight_working_dir_resolution: None,
            in_flight_working_dir_completion: None,
            pending_clean_session_create: None,
            in_flight_clean_session_create: None,
