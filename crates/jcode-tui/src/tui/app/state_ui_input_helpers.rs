...
const REGISTERED_COMMANDS: &[RegisteredCommand] = &[
    ...
    RegisteredCommand::public("/pwd", "Print the exact session working directory"),
    ...
    RegisteredCommand::public("/resume", "Browse session history"),
    RegisteredCommand::public("/sessions", "Switch between live sessions"),
    RegisteredCommand::public("/session", "Switch between live sessions"),
    RegisteredCommand::public("/active", "Alias for /sessions"),
